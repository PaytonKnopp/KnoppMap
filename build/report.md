...
- **Quarter Section Perimeter**: closed loop (gap 7.0 m)
- **Cabin Perimeter**: closed loop (gap 2.0 m)
- **Acreage Perimeter**: closed loop (gap 0.7 m)

### Joined recording segments

- **Quarter Section Perimeter**: joined paused segment (gap 2 m)
- **Quarter Section Perimeter**: joined paused segment (gap 0 m)
- **Quarter Section Perimeter**: joined paused segment (gap 3 m)
- **Quarter Section Perimeter**: joined paused segment (gap 1 m)
- **Quarter Section Perimeter**: joined paused segment (gap 2 m)
- **Quarter Section Perimeter**: joined paused segment (gap 1 m)
...
| Golf Range | end | Larry's Crossing | joined | 0.5 | 0.0 |
